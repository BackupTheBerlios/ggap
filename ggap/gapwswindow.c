...
static GapView *gap_ws_window_get_terminal  (GapWindow      *window);
...
gap_ws_window_class_init (GapWsWindowClass *klass)
{
    ...
    gwindow_class->get_terminal = gap_ws_window_get_terminal;
...
static GapView *
gap_ws_window_get_terminal (GapWindow *window)
{
    return GAP_VIEW (GAP_WS_WINDOW (window)->priv->ws);
}
